...
with right_column:
    ...
    monod_chlorella = monod2(mu_maxChlorella, rango_nitrogeno, kn_chlorella)
    monod_scenedesmus = monod2(mu_maxScenedesmus, rango_nitrogeno, kn_scenedesmus)
    monod_planktothrix = monod2(mu_maxPlanktothrix, rango_nitrogeno, kn_planktothrix)
