...
with right_column:
    ...
    if st.button("Aplicar", type="primary", key="btn_aplicar"):
        ...
        #C    H    L    O    R    E    L    L    A
        st.session_state.mu_chlorella = monod(st.session_state.nitrogeno_actual,2.5)
        ...
        st.session_state.mu_scenedesmus = monod(st.session_state.nitrogeno_actual,0.1)
        ...
        st.session_state.mu_planktothrix = monod(st.session_state.nitrogeno_actual,1.5)
